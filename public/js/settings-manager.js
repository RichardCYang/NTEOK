...
async function exportBackup() {
    try {
         ...
         * 
         * 편집 내용은 실시간 협업(Yjs) 및 디바운스 저장을 통해 서버에 지연 반영될 수 있음
         * 사용자가 편집 직후 백업을 내보내면 최신 변경분이 DB에 아직 저장되지 않아 백업 파일에 누락될 위험이 있음
         * 
         * 이를 방지하기 위해 백업 요청 전, 현재 열려 있는 페이지의 편집 내용을 WebSocket force-save를 통해 즉시 저장함
         */
        try {
